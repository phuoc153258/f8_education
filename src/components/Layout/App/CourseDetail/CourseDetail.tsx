    ...
    return (
        <div className={clsx('index-module_row', styles.wrapper)}>
            <section className="index-module_col index-module_c-12 index-module_m-12 index-module_l-8">
                <h1 className={styles.courseName}>Làm việc với Terminal & Ubuntu</h1>
                        ...
                        <section className="index-module_col index-module_c-12 index-module_m-12 index-module_l-12">
                            <ul className={styles.list}>
                                <li>
                                    ...
                                    <span>Biết cách cài đặt và tùy biến Windows Terminal</span>
                                </li>
                                <li>
                                    <svg
                                        aria-hidden="true"
                        ...
                        <section className="index-module_col index-module_c-12 index-module_m-12 index-module_l-12">
                            <ul className={clsx(styles.list, styles.column, 'f-column')}>
                                <li>
                                    ...
                                    <span>Máy tính kết nối internet (từ Windows 10 trở lên)</span>
                                </li>
                                <li>
                                    <svg
                                        aria-hidden="true"
            ...
            <section className="index-module_col index-module_c-12 index-module_m-12 index-module_l-4">
                <div className={styles.purchaseBadge}>
                    <div className={styles.imgPreview}>
                        <div
                            className={styles.bg}
                            style={{ backgroundImage: `url(${ENV.apiUrl}/api/v1/file/course_image_7.png)` }}
                        ></div>
                        <svg
                            aria-hidden="true"
                            focusable="false"
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <span>
                                Tổng số <strong>42</strong> bài học
                            </span>
                        </li>
                        <li>
                            <svg
